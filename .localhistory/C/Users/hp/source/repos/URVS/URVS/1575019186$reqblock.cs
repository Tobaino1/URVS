    ...
    public partial class Reqblock : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox4.Text == "" & textBox2.Text == "" &  textBox9.Text == "")
            {
                ...
                textBox13.Text = validation_report.ToString();

                MessageBox.Show("POSTERIOR P(A|B) OR P(A) && LIKELIHOOD P(B|A) OR P(B) are missing, Please enter probable / assumed value inorder to get validation requirements report!");
                return;
            }                  
        }
