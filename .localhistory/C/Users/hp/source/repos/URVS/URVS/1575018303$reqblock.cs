    ...
    public partial class Reqblock : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox4.Text == "" & textBox2.Text == "" &  textBox9.Text == "")
            {
                ...
                MessageBox.Show("POSTERIOR P(A|B) OR P(A) && LIKELIHOOD P(B|A) OR P(B) are missing, please enter probable / assumed value inorder to get validate requirements report!");
                return;
            }                  
        }
